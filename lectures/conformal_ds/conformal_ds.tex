...
\eqref{eq:pw}, which themselves depend on the data. This is the primary reason
that we use the quantile form in \eqref{eq:weighted_conf}, since we can always
use the unadjusted level $1-\alpha$ and completely avoid these complications.  
