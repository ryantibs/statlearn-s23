...
set \smash{$C_t^\beta \subseteq \cY$} for $Y_t$, at any nominal level $\beta \in 
...
\begin{figure}[htb]
\hspace{-30pt}
\includegraphics[width=1.1\textwidth]{stocks.png}
...
\eqref{eq:aci} an instance of online gradient descent,\footnote{Actually, to be
  specific, this is the online subgradient method; but we'll ignore this
  distinction in nomenclature.} 
applied to the convex problem
\[
