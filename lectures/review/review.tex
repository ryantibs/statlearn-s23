...
think that this is a different model from an XY-Pairs model, but it's actually
the same, for i.i.d.\ mean zero stochastic errors $\epsilon_i$, $i=1,\dots,n$,
...
\text{and $(x_i,z_i,\xi_i)$, $i=1,\dots,n$ are i.i.d.}
\end{gather*}
...
terminology as many authors use ``risk'' and ``error'' interchangeably, and do
not use it to distinguish whether the target is $f(x_0)$ or $y_0$.
