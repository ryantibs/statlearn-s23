...
\smash{$\E\|\hf-f_0\|_2^2 \to 0$} as $n \to \infty$, provided we use a compactly
supported kernel $K$ and a bandwidth $h=h_n$ such that $h_n \to 0$ and $nh_n^d
\to \infty$ as $n \to \infty$. See Chapter 5.2 of
