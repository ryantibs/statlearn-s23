...
This is an optional bonus problem. Generalize the univariate calculation given
in the minimax lecture to the multivariate case, to show that for the
$d$-dimensional H{\"o}lder ball   
\[
...
C n^{-2k/(2k+d)}. 
\]
To be clear, here \smash{$\|g\|_2^2 = \int_{[0,1]^d} g(x)^2 \, dx$}. Make sure
